...
export const list = v.object({
	items: v.array(v.omit(base, ['instance_id', 'collection_template_id', 'content_template_id'])),
	count: count
});
export type List = v.InferOutput<typeof list>;

export const create = v.pick(base, [
	'name',
	'slug',
...
export const update = v.partial(
	v.pick(base, ['name', 'slug', 'collection_template_id', 'content_template_id', 'active'])
);
