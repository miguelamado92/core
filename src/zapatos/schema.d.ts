...
declare module 'zapatos/schema' {
	...
	export namespace admins {
		...
		export interface Whereable {
			 ...
			 */
			permissions?:
				| c.PgAdmin_permissions
				| db.Parameter<c.PgAdmin_permissions>
				| db.SQLFragment
				| db.ParentColumn
				| db.SQLFragment<
						any,
	...
	export namespace functions {
		...
		export interface Whereable {
			...
			steps?:
				| c.PgFunction_steps
				| db.Parameter<c.PgFunction_steps>
				| db.SQLFragment
				| db.ParentColumn
				| db.SQLFragment<
						any,
						c.PgFunction_steps | db.Parameter<c.PgFunction_steps> | db.SQLFragment | db.ParentColumn
				  >;
			/**
			 * **functions.updated_at**
			 * - `timestamptz` in database
		...
		export interface Updatable {
			...
			steps?:
				...
				| db.SQLFragment<
						any,
						c.PgFunction_steps | db.Parameter<c.PgFunction_steps> | db.DefaultType | db.SQLFragment
				  >;
			/**
			 * **functions.updated_at**
			 * - `timestamptz` in database
	...
	export namespace instances {
		...
		export interface Whereable {
			 ...
			 */
			secrets?:
				| c.PgInstance_secrets
				| db.Parameter<c.PgInstance_secrets>
				| db.SQLFragment
				| db.ParentColumn
				| db.SQLFragment<
						any,
			 ...
			 */
			settings?:
				| c.PgInstance_settings
				| db.Parameter<c.PgInstance_settings>
				| db.SQLFragment
				| db.ParentColumn
				| db.SQLFragment<
						any,
		...
		export type UniqueIndex =
			...
			| 'instances_owner_email_unique'
			| 'instances_pkey'
			| 'instances_slug_unique';
		export type Column = keyof Selectable;
		export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
		export type SQLExpression =
			| Table
	...
	export namespace tasks {
		...
		export interface Whereable {
			...
			details?:
				| c.PgTask_details
				| db.Parameter<c.PgTask_details>
				| db.SQLFragment
				| db.ParentColumn
				| db.SQLFragment<
						any,
						c.PgTask_details | db.Parameter<c.PgTask_details> | db.SQLFragment | db.ParentColumn
				  >;
			/**
			 * **tasks.due_at**
			 * - `timestamptz` in database
		...
		export interface Updatable {
			...
			details?:
				...
				| db.Parameter<c.PgTask_details>
				| db.SQLFragment
				| db.SQLFragment<any, c.PgTask_details | db.Parameter<c.PgTask_details> | db.SQLFragment>;
			/**
			 * **tasks.due_at**
			 * - `timestamptz` in database
			 * - Nullable, no default
	...
	export namespace public {
		...
		export type Selectable =
			...
			| sessions.Selectable
			| spatial_ref_sys.Selectable
			| tags.Selectable
			| task_taggings.Selectable
			| tasks.Selectable;
		export type JSONSelectable =
			| admins.JSONSelectable
			| functions.JSONSelectable
			| instances.JSONSelectable
			| sessions.JSONSelectable
			| spatial_ref_sys.JSONSelectable
			| tags.JSONSelectable
			| task_taggings.JSONSelectable
			| tasks.JSONSelectable;
		export type Whereable =
			| admins.Whereable
			| functions.Whereable
			| instances.Whereable
			| sessions.Whereable
			| spatial_ref_sys.Whereable
			| tags.Whereable
			| task_taggings.Whereable
			| tasks.Whereable;
		export type Insertable =
			| admins.Insertable
			| functions.Insertable
			| instances.Insertable
			| sessions.Insertable
			| spatial_ref_sys.Insertable
			| tags.Insertable
			| task_taggings.Insertable
			| tasks.Insertable;
		export type Updatable =
			...
			| instances.Updatable
			| sessions.Updatable
			| spatial_ref_sys.Updatable
			| tags.Updatable
			| task_taggings.Updatable
			| tasks.Updatable;
		export type UniqueIndex =
			| admins.UniqueIndex
			| functions.UniqueIndex
			| instances.UniqueIndex
			| sessions.UniqueIndex
			| spatial_ref_sys.UniqueIndex
			| tags.UniqueIndex
			| task_taggings.UniqueIndex
			| tasks.UniqueIndex;
		export type Column =
			| admins.Column
			| functions.Column
			| instances.Column
			| sessions.Column
			| spatial_ref_sys.Column
			| tags.Column
			| task_taggings.Column
			| tasks.Column;
	...
	export namespace people {
		...
		export namespace custom_fields {
			...
			export interface Whereable {
				 ...
				 */
				validation?:
					| c.PgValidation_rules
					| db.Parameter<c.PgValidation_rules>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
			...
			export type UniqueIndex =
				| 'custom_fields_instance_id_name_unique'
				| 'custom_fields_instance_id_slug_unique'
				| 'custom_fields_pkey';
			export type Column = keyof Selectable;
			export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
			export type SQLExpression =
		...
		export namespace interactions {
			...
			export interface Whereable {
				 ...
				 */
				details?:
					| c.PgInteraction_type
					| db.Parameter<c.PgInteraction_type>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
		...
		export namespace people {
			...
			export interface Whereable {
				...
				email?:
					| c.PgEmail
					| db.Parameter<c.PgEmail>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
							c.PgEmail | db.Parameter<c.PgEmail> | db.SQLFragment | db.ParentColumn
					  >;
				/**
				 * **people.people.family_name**
				 * - `text` in database
				...
				latlng?:
					| c.PgGeometry
					| db.Parameter<c.PgGeometry>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
							c.PgGeometry | db.Parameter<c.PgGeometry> | db.SQLFragment | db.ParentColumn
					  >;
				/**
				 * **people.people.locality**
				 * - `text` in database
				...
				phone_number?:
					| c.PgPhone_number
					| db.Parameter<c.PgPhone_number>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
							c.PgPhone_number | db.Parameter<c.PgPhone_number> | db.SQLFragment | db.ParentColumn
					  >;
				/**
				 * **people.people.point_person_id**
				 * - `int4` in database
				...
				whatsapp?:
					| c.PgWhatsapp
					| db.Parameter<c.PgWhatsapp>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
							c.PgWhatsapp | db.Parameter<c.PgWhatsapp> | db.SQLFragment | db.ParentColumn
					  >;
			}
			export interface Insertable {
				/**
			...
			export interface Updatable {
				...
				email?:
					...
					| db.SQLFragment<
							any,
							c.PgEmail | db.Parameter<c.PgEmail> | null | db.DefaultType | db.SQLFragment
					  >;
				/**
				 * **people.people.family_name**
				 * - `text` in database
				...
				latlng?:
					...
					| db.SQLFragment<
							any,
							c.PgGeometry | db.Parameter<c.PgGeometry> | null | db.DefaultType | db.SQLFragment
					  >;
				/**
				 * **people.people.locality**
				 * - `text` in database
		...
		export type Table =
			...
			| taggings.Table;
		export type Selectable =
			| custom_field_values.Selectable
			| custom_fields.Selectable
			| group_members.Selectable
			| groups.Selectable
			| imports.Selectable
			| interactions.Selectable
			| list_interactions.Selectable
			| list_people.Selectable
			| list_view.Selectable
			| lists.Selectable
			| people.Selectable
			| people_search.Selectable
			| taggings.Selectable;
		export type JSONSelectable =
			| custom_field_values.JSONSelectable
			| custom_fields.JSONSelectable
			| group_members.JSONSelectable
			| groups.JSONSelectable
			| imports.JSONSelectable
			| interactions.JSONSelectable
			| list_interactions.JSONSelectable
			| list_people.JSONSelectable
			| list_view.JSONSelectable
			| lists.JSONSelectable
			| people.JSONSelectable
			| people_search.JSONSelectable
			| taggings.JSONSelectable;
		export type Whereable =
			| custom_field_values.Whereable
			| custom_fields.Whereable
			| group_members.Whereable
			| groups.Whereable
			| imports.Whereable
			| interactions.Whereable
			| list_interactions.Whereable
			| list_people.Whereable
			| list_view.Whereable
			| lists.Whereable
			| people.Whereable
			| people_search.Whereable
			| taggings.Whereable;
		export type Insertable =
			| custom_field_values.Insertable
			| custom_fields.Insertable
			| group_members.Insertable
			| groups.Insertable
			| imports.Insertable
			| interactions.Insertable
			| list_interactions.Insertable
			| list_people.Insertable
			| list_view.Insertable
			| lists.Insertable
			| people.Insertable
			| people_search.Insertable
			| taggings.Insertable;
		export type Updatable =
			| custom_field_values.Updatable
			| custom_fields.Updatable
			| group_members.Updatable
			| groups.Updatable
			| imports.Updatable
			| interactions.Updatable
			| list_interactions.Updatable
			| list_people.Updatable
			| list_view.Updatable
			| lists.Updatable
			| people.Updatable
			| people_search.Updatable
			| taggings.Updatable;
		export type UniqueIndex =
			| custom_field_values.UniqueIndex
			| custom_fields.UniqueIndex
			| group_members.UniqueIndex
			| groups.UniqueIndex
			| imports.UniqueIndex
			| interactions.UniqueIndex
			| list_interactions.UniqueIndex
			| list_people.UniqueIndex
			| list_view.UniqueIndex
			| lists.UniqueIndex
			| people.UniqueIndex
			| people_search.UniqueIndex
			| taggings.UniqueIndex;
		export type Column =
			| custom_field_values.Column
			| custom_fields.Column
			| group_members.Column
			| groups.Column
			| imports.Column
			| interactions.Column
			| list_interactions.Column
			| list_people.Column
			| list_view.Column
			| lists.Column
			| people.Column
			| people_search.Column
			| taggings.Column;
	...
	export namespace website {
		...
		export namespace blocks {
			...
			export type UniqueIndex =
				| 'blocks_instance_id_name_unique'
				| 'blocks_instance_id_slug_unique'
				| 'blocks_pkey';
			export type Column = keyof Selectable;
			export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
			export type SQLExpression =
		...
		export namespace content {
			...
			export interface Whereable {
				...
				custom_code?:
					| c.PgCustom_code
					| db.Parameter<c.PgCustom_code>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
							c.PgCustom_code | db.Parameter<c.PgCustom_code> | db.SQLFragment | db.ParentColumn
					  >;
				/**
				 * **website.content.deleted_at**
				 * - `timestamptz` in database
				...
				html_metatags?:
					| c.PgHtml_metatags
					| db.Parameter<c.PgHtml_metatags>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
							c.PgHtml_metatags | db.Parameter<c.PgHtml_metatags> | db.SQLFragment | db.ParentColumn
					  >;
				/**
				 * **website.content.id**
				 * - `int4` in database
			...
			export interface Updatable {
				...
				custom_code?:
					...
					| db.SQLFragment<
							any,
							c.PgCustom_code | db.Parameter<c.PgCustom_code> | db.DefaultType | db.SQLFragment
					  >;
				/**
				 * **website.content.deleted_at**
				 * - `timestamptz` in database
				...
				html_metatags?:
					...
					| db.SQLFragment<
							any,
							c.PgHtml_metatags | db.Parameter<c.PgHtml_metatags> | db.DefaultType | db.SQLFragment
					  >;
				/**
				 * **website.content.id**
				 * - `int4` in database
			...
			export type UniqueIndex =
				| 'content_content_type_id_name_unique'
				| 'content_content_type_id_slug_unique'
				| 'content_pkey';
			export type Column = keyof Selectable;
			export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
			export type SQLExpression =
		...
		export namespace content_types {
			...
			export type UniqueIndex =
				| 'content_types_instance_id_name_unique'
				| 'content_types_instance_id_slug_unique'
				| 'content_types_pkey';
			export type Column = keyof Selectable;
			export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
			export type SQLExpression =
		...
		export type Selectable =
			| blocks.Selectable
			| content.Selectable
			| content_types.Selectable
			| redirects.Selectable
			| taggings.Selectable
			| uploads.Selectable;
		export type JSONSelectable =
			| blocks.JSONSelectable
			| content.JSONSelectable
			| content_types.JSONSelectable
			| redirects.JSONSelectable
			| taggings.JSONSelectable
			| uploads.JSONSelectable;
		export type Whereable =
			| blocks.Whereable
			| content.Whereable
			| content_types.Whereable
			| redirects.Whereable
			| taggings.Whereable
			| uploads.Whereable;
		export type Insertable =
			| blocks.Insertable
			| content.Insertable
			| content_types.Insertable
			| redirects.Insertable
			| taggings.Insertable
			| uploads.Insertable;
		export type Updatable =
			| blocks.Updatable
			| content.Updatable
			| content_types.Updatable
			| redirects.Updatable
			| taggings.Updatable
			| uploads.Updatable;
		export type UniqueIndex =
			| blocks.UniqueIndex
			| content.UniqueIndex
			| content_types.UniqueIndex
			| redirects.UniqueIndex
			| taggings.UniqueIndex
			| uploads.UniqueIndex;
		export type Column =
			| blocks.Column
	...
	export namespace communications {
		...
		export namespace received_whatsapp_group_messages {
			...
			export interface Whereable {
				 ...
				 */
				message?:
					| c.PgIncoming_whatsapp_message
					| db.Parameter<c.PgIncoming_whatsapp_message>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
		...
		export namespace sent_whatsapp_messages {
			...
			export interface Whereable {
				 ...
				 */
				message?:
					| c.PgWhatsapp_message
					| db.Parameter<c.PgWhatsapp_message>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
			...
			export interface Updatable {
				...
				message?:
					...
					| db.SQLFragment<
							any,
							c.PgWhatsapp_message | db.Parameter<c.PgWhatsapp_message> | db.SQLFragment
					  >;
				/**
				 * **communications.sent_whatsapp_messages.message_id**
				 * - `uuid` in database
		...
		export namespace sms_messages {
			...
			export interface Whereable {
				 ...
				 */
				actions?:
					| c.PgCommunication_actions
					| db.Parameter<c.PgCommunication_actions>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
				 ...
				 */
				keywords?:
					| c.PgKeyword_triggers
					| db.Parameter<c.PgKeyword_triggers>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
		...
		export namespace whatsapp_conversations {
			...
			export type UniqueIndex =
				...
				| 'whatsapp_conversations_whatsapp_id_unique';
			export type Column = keyof Selectable;
			export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
			export type SQLExpression =
				| Table
		...
		export namespace whatsapp_quick_replies {
			...
			export type UniqueIndex =
				| 'whatsapp_quick_replies_pkey'
				| 'whatsapp_quick_replies_thread_id_name_unique';
			export type Column = keyof Selectable;
			export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
			export type SQLExpression =
				| Table
		...
		export namespace whatsapp_templates {
			...
			export interface Whereable {
				 ...
				 */
				message?:
					| c.PgWhatsapp_template
					| db.Parameter<c.PgWhatsapp_template>
					| db.SQLFragment
					| db.ParentColumn
					| db.SQLFragment<
							any,
			...
			export interface Updatable {
				...
				message?:
					...
					| db.SQLFragment<
							any,
							c.PgWhatsapp_template | db.Parameter<c.PgWhatsapp_template> | db.SQLFragment
					  >;
				/**
				 * **communications.whatsapp_templates.name**
				 * - `text` in database
			...
			export type UniqueIndex =
				| 'whatsapp_templates_instance_id_name_unique'
				| 'whatsapp_templates_instance_id_whatsapp_id_unique'
		...
		export namespace whatsapp_threads {
			...
			export type UniqueIndex =
				| 'whatsapp_threads_instance_id_name_unique'
				| 'whatsapp_threads_pkey';
			export type Column = keyof Selectable;
			export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
			export type SQLExpression =
				| Table
		...
		export type Table =
			...
			| received_whatsapp_messages.Table
			| sent_emails.Table
			| sent_sms.Table
			| sent_whatsapp_messages.Table
			| sms_messages.Table
			| sms_numbers.Table
			| sms_sends.Table
			| sms_threads.Table
		...
		export type Selectable =
			...
			| received_whatsapp_messages.Selectable
			| sent_emails.Selectable
			| sent_sms.Selectable
			| sent_whatsapp_messages.Selectable
			| sms_messages.Selectable
			| sms_numbers.Selectable
			| sms_sends.Selectable
			| sms_threads.Selectable
			| whatsapp_conversations.Selectable
			| whatsapp_messages.Selectable
			| whatsapp_numbers.Selectable
			| whatsapp_quick_replies.Selectable
			| whatsapp_sends.Selectable
			| whatsapp_templates.Selectable
			| whatsapp_threads.Selectable;
		export type JSONSelectable =
			...
			| received_whatsapp_messages.JSONSelectable
			| sent_emails.JSONSelectable
			| sent_sms.JSONSelectable
			| sent_whatsapp_messages.JSONSelectable
			| sms_messages.JSONSelectable
			| sms_numbers.JSONSelectable
			| sms_sends.JSONSelectable
			| sms_threads.JSONSelectable
			| whatsapp_conversations.JSONSelectable
			| whatsapp_messages.JSONSelectable
			| whatsapp_numbers.JSONSelectable
			| whatsapp_quick_replies.JSONSelectable
			| whatsapp_sends.JSONSelectable
			| whatsapp_templates.JSONSelectable
			| whatsapp_threads.JSONSelectable;
		export type Whereable =
			...
			| received_whatsapp_messages.Whereable
			| sent_emails.Whereable
			| sent_sms.Whereable
			| sent_whatsapp_messages.Whereable
			| sms_messages.Whereable
			| sms_numbers.Whereable
			| sms_sends.Whereable
			| sms_threads.Whereable
			| whatsapp_conversations.Whereable
			| whatsapp_messages.Whereable
			| whatsapp_numbers.Whereable
			| whatsapp_quick_replies.Whereable
			| whatsapp_sends.Whereable
			| whatsapp_templates.Whereable
			| whatsapp_threads.Whereable;
		export type Insertable =
			...
			| received_whatsapp_messages.Insertable
			| sent_emails.Insertable
			| sent_sms.Insertable
			| sent_whatsapp_messages.Insertable
			| sms_messages.Insertable
			| sms_numbers.Insertable
			| sms_sends.Insertable
			| sms_threads.Insertable
			| whatsapp_conversations.Insertable
			| whatsapp_messages.Insertable
			| whatsapp_numbers.Insertable
			| whatsapp_quick_replies.Insertable
			| whatsapp_sends.Insertable
			| whatsapp_templates.Insertable
			| whatsapp_threads.Insertable;
		export type Updatable =
			...
			| received_whatsapp_messages.Updatable
			| sent_emails.Updatable
			| sent_sms.Updatable
			| sent_whatsapp_messages.Updatable
			| sms_messages.Updatable
			| sms_numbers.Updatable
			| sms_sends.Updatable
			| sms_threads.Updatable
			| whatsapp_conversations.Updatable
			| whatsapp_messages.Updatable
			| whatsapp_numbers.Updatable
			| whatsapp_quick_replies.Updatable
			| whatsapp_sends.Updatable
			| whatsapp_templates.Updatable
			| whatsapp_threads.Updatable;
		export type UniqueIndex =
			...
			| received_whatsapp_messages.UniqueIndex
			| sent_emails.UniqueIndex
			| sent_sms.UniqueIndex
			| sent_whatsapp_messages.UniqueIndex
			| sms_messages.UniqueIndex
			| sms_numbers.UniqueIndex
			| sms_sends.UniqueIndex
			| sms_threads.UniqueIndex
			| whatsapp_conversations.UniqueIndex
			| whatsapp_messages.UniqueIndex
			| whatsapp_numbers.UniqueIndex
			| whatsapp_quick_replies.UniqueIndex
			| whatsapp_sends.UniqueIndex
			| whatsapp_templates.UniqueIndex
			| whatsapp_threads.UniqueIndex;
		export type Column =
			...
			| received_whatsapp_messages.Column
			| sent_emails.Column
			| sent_sms.Column
			| sent_whatsapp_messages.Column
			| sms_messages.Column
			| sms_numbers.Column
			| sms_sends.Column
			| sms_threads.Column
			| whatsapp_conversations.Column
			| whatsapp_messages.Column
			| whatsapp_numbers.Column
			| whatsapp_quick_replies.Column
			| whatsapp_sends.Column
			| whatsapp_templates.Column
			| whatsapp_threads.Column;
	...
	export namespace events {
		...
		export namespace events {
			...
			export interface Whereable {
				 ...
				 * - `NOT NULL`, default: `24`
				 */
				send_reminder_hours_before_start?:
					| number
					| db.Parameter<number>
					| db.SQLFragment
					| db.ParentColumn
			...
			export type UniqueIndex =
				| 'events_instance_id_name_unique'
				| 'events_instance_id_slug_unique'
				| 'events_pkey';
			export type Column = keyof Selectable;
			export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
			export type SQLExpression =
		...
		export type Table =
			| attendees.Table
			| event_attendees_view.Table
			| events.Table
			| taggings.Table;
		export type Selectable =
			| attendees.Selectable
			| event_attendees_view.Selectable
			| events.Selectable
			| taggings.Selectable;
		export type JSONSelectable =
			| attendees.JSONSelectable
			| event_attendees_view.JSONSelectable
			| events.JSONSelectable
			| taggings.JSONSelectable;
		export type Whereable =
			| attendees.Whereable
			| event_attendees_view.Whereable
			| events.Whereable
			| taggings.Whereable;
		export type Insertable =
			| attendees.Insertable
			| event_attendees_view.Insertable
			| events.Insertable
			| taggings.Insertable;
		export type Updatable =
			| attendees.Updatable
			| event_attendees_view.Updatable
			| events.Updatable
			| taggings.Updatable;
		export type UniqueIndex =
			| attendees.UniqueIndex
			| event_attendees_view.UniqueIndex
			| events.UniqueIndex
			| taggings.UniqueIndex;
		export type Column =
			| attendees.Column
			| event_attendees_view.Column
			| events.Column
			| taggings.Column;
	...
	export namespace petitions {
		...
		export namespace petitions {
			...
			export type UniqueIndex =
				| 'petitions_instance_id_name_unique'
				| 'petitions_instance_id_slug_unique'
				| 'petitions_pkey';
			export type Column = keyof Selectable;
			export type OnlyCols<T extends readonly Column[]> = Pick<Selectable, T[number]>;
			export type SQLExpression =
		...
		export type Table =
			| petition_signatures_view.Table
			| petitions.Table
			| signatures.Table
			| taggings.Table;
		export type Selectable =
			| petition_signatures_view.Selectable
			| petitions.Selectable
			| signatures.Selectable
			| taggings.Selectable;
		export type JSONSelectable =
			| petition_signatures_view.JSONSelectable
			| petitions.JSONSelectable
			| signatures.JSONSelectable
			| taggings.JSONSelectable;
		export type Whereable =
			| petition_signatures_view.Whereable
			| petitions.Whereable
			| signatures.Whereable
			| taggings.Whereable;
		export type Insertable =
			| petition_signatures_view.Insertable
			| petitions.Insertable
			| signatures.Insertable
			| taggings.Insertable;
		export type Updatable =
			| petition_signatures_view.Updatable
			| petitions.Updatable
			| signatures.Updatable
			| taggings.Updatable;
		export type UniqueIndex =
			| petition_signatures_view.UniqueIndex
			| petitions.UniqueIndex
			| signatures.UniqueIndex
			| taggings.UniqueIndex;
		export type Column =
			| petition_signatures_view.Column
			| petitions.Column
			| signatures.Column
			| taggings.Column;
	...
	export type Selectable =
		...
		| petitions.Selectable;
	export type JSONSelectable =
		| public.JSONSelectable
		| people.JSONSelectable
		| website.JSONSelectable
		| communications.JSONSelectable
		| events.JSONSelectable
		| petitions.JSONSelectable;
	export type Whereable =
		| public.Whereable
	...
	export type AllBaseTables = [
		...public.AllBaseTables,
		...people.AllBaseTables,
		...website.AllBaseTables,
		...communications.AllBaseTables,
		...events.AllBaseTables,
		...petitions.AllBaseTables
	];
	export type AllForeignTables = [
		...public.AllForeignTables,
		...people.AllForeignTables,
		...website.AllForeignTables,
		...communications.AllForeignTables,
		...events.AllForeignTables,
		...petitions.AllForeignTables
	];
	export type AllViews = [
		...public.AllViews,
		...people.AllViews,
		...website.AllViews,
		...communications.AllViews,
		...events.AllViews,
		...petitions.AllViews
	];
	export type AllMaterializedViews = [
		...public.AllMaterializedViews,
		...people.AllMaterializedViews,
		...website.AllMaterializedViews,
		...communications.AllMaterializedViews,
		...events.AllMaterializedViews,
		...petitions.AllMaterializedViews
	];
	export type AllTablesAndViews = [
		...public.AllTablesAndViews,
		...people.AllTablesAndViews,
		...website.AllTablesAndViews,
		...communications.AllTablesAndViews,
		...events.AllTablesAndViews,
		...petitions.AllTablesAndViews
	];
